        ...
        <div style="background:var(--bg-light); padding:2rem; border-radius:10px; border:1px solid var(--border-color);">
            ...
            <form id="checkoutForm" action="checkout.php" method="POST">
                ...
                <div class="form-group" style="margin-top: 1.5rem;">
                    <label style="font-size: 1.1rem; color: var(--primary-color); border-bottom: 1px solid var(--border-color); padding-bottom: 5px; margin-bottom: 15px;">Payment Method</label>
                    
                    <div style="margin-bottom: 10px;">
                        <label style="display: flex; align-items: center; gap: 10px; cursor: pointer; color: var(--text-main);">
                            <input type="radio" name="payment_method" value="mobile" checked onchange="document.getElementById('mobile_pay_options').style.display='block'">
                            Direct Mobile Payment (GPay, PhonePe, Paytm)
                        </label>
                    </div>
                    
                    <div id="mobile_pay_options" style="display: block; padding: 15px; background: var(--bg-dark); border-radius: 5px; margin-top: 10px; border-left: 4px solid var(--primary-color);">
                        <p style="color: var(--text-main); font-size: 0.95rem; line-height: 1.5;">
                            Please send your total amount to: <br>
                            <strong style="font-size: 1.3rem; color: var(--primary-color); letter-spacing: 1px; display:inline-block; margin: 10px 0;">8890808630</strong><br>
                            After making the transfer, click <b>Proceed to Pay</b> below. Our team will verify your transfer and ship your order!
                        </p>
                    </div>
                </div>
                
                <button type="button" class="btn" onclick="processPayment()" style="width:100%; font-size:1.1rem; padding:1rem; margin-top: 1rem;"><i class="fas fa-lock"></i> Proceed to Pay / Place Order</button>
            </form>
        </div>
